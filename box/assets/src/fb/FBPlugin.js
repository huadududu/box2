...
module.exports = function () {
    ...
    let plugin =  cc.Class({
        ...
        entryGiftAsync:function (callback) {
        ...
        InterstitialAdAsync:function (callback) {//插屏广告
        ...
        RewardedVideoAsync:function (callback) {//激励视频
            let GameConfig = require("GameConfig");
            var ad = null;
