(function () {
    ...
    function boot () {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.dd1b7.js' : 'src/project.js';
        if (jsList) {
    ...
    if (false) {
        (function () {
            ...
            require('src/settings.faab9.js');
            require(window._CCSettings.debug ? 'cocos2d-js.5902d.js' : 'cocos2d-js-min.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.5902d.js' : 'cocos2d-js-min.js';
