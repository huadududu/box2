(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/src/fb/FBPlugin.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '75c587Fo41PHbXljhPIbwGc', 'FBPlugin', __filename);
// src/fb/FBPlugin.js
...
module.exports = function () {
    ...
    var plugin = cc.Class({
        ...
        shareFb: function shareFb() {
            var intent = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'REQUEST';
        ...
        chooseAsync: function chooseAsync(callback, errorCallback) {
        ...
        updateAsync: function updateAsync(usertext, callback) {

            var text = FBInstant.player.getName() + usertext;
        ...
        updateHighAsync: function updateHighAsync(usertext, callback) {
        ...
        updateGiftAsync: function updateGiftAsync(gifttype, count, callback, errorCallback) {

            var text = "Only 10 players can get an extra life in an hour from " + FBInstant.player.getName() + " . ";
            FBInstant.updateAsync({
                action: 'CUSTOM',
                cta: 'Join The Fight',
                image: sharePng,
                ...
                template: 'send_gift',
                data: { gifttype: gifttype, time: Date.now(), count: count, from: FBInstant.player.getName() },
                strategy: 'IMMEDIATE',
                notification: 'NO_PUSH'
            }).then(function () {
                console.log('Message was sent successfully');
        ...
        entryGiftAsync: function entryGiftAsync(callback) {
            var entryPointData = FBInstant.getEntryPointData();
            if (entryPointData) {
                var gifttype = entryPointData['gifttype'];
                var time = entryPointData['time'];
                var count = entryPointData['count'];
                var from = entryPointData['from'];
                if (callback) {
                    callback(gifttype, time, count, from);
                }
            }
        },
        ...
        //    game play
        getOrCreateContextId: function getOrCreateContextId() {
        ...
        LeaderboardCount: function LeaderboardCount() {
            var leaderName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'my_leaderboard';
            var callback = arguments[1];

            FBInstant.getLeaderboardAsync(leaderName).then(function (leaderboard) {
        ...
        getFriendLeaderboard: function getFriendLeaderboard() {
            var leaderName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'my_leaderboard';
            var callback = arguments[1];
        ...
        getWorldLeaderboard: function getWorldLeaderboard() {
            var leaderName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'my_leaderboard';
            var callback = arguments[1];
        ...
        //玩家自己的
        getPlayerLeaderboard: function getPlayerLeaderboard() {
            var leaderName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'my_leaderboard';
            var callback = arguments[1];
        ...
        ConnectedPlayers: function ConnectedPlayers(callback) {
        ...
        switchGame: function switchGame(gameid) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=FBPlugin.js.map
